export const levels = [
  ...
  [
    {
      ...
      “main-table” oraz “footer”). Rozpocznij od przejrzenia zawartości pliku oraz
  ...
  [
    ...
    {
      message: `Jedną z nich jest ‘git rebase’. Pomoże nam ona uporządkować historię
      naszego repozytorium. Pracowałeś ostatnio nad dwiema gałęziami, z których jedna
  ...
  [
    {
      message: `Ten poziom będzie krótką odskocznią od rozwiązywania konfliktów,
      jednak niesie on ze sobą bardzo przydatną wiedzę. Wyobraź sobie sytuację, gdzie
      w pracy dostałeś zlecenie na wykonanie połączenia dwóch (lub więcej)
  ...
  [
    ...
    },
    {
      ...
      a następnie połącz gałęzie ‘pat’ i ‘mat’ (jeżeli zajdzie konflikt, to
  ...
  [
    ...
    },
    {
      ...
      strategii przy scalaniu gałęzi. I tak gdy podamy ‘-X ours’ to wszystkie
    ...
    },
    {
      ...
      (zawsze zostawiając wersje z gałęzi rodziców), albo skorzystać z flagi -X`,
      width: '600px',
      height: '150px',
      stage: 1,
    },
...
export const tasks = [
  ...
  odrzuci nieskomitowane zmiany z tego pliku, sytuacja ulegnie zmianie.`,
